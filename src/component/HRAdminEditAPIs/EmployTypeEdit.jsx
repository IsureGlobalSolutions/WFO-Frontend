...
import { addEditEmplyeetype, getEmployeeTypeById, getEmployetypeData } from '../../redux/features/auth/authSlice';
...
const EmployTypeEdit = ({ EditId , active  , setActive}) => {
  ...
  useEffect(() => {
    if (EditId) {
      ...
      const fetchDepartment = async () => {
        try {
          const response = await dispatch(getEmployeeTypeById(EditId));
          if (response.payload) {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      const response = await dispatch(addEditEmplyeetype(Depformvalue));
  ...
  return (
    ...
    <Modal.Body className="p-4 pt-3 " >
      <div className="d-flex justify-content-between align-items-center mb-4 m-3">
        <h4 className="m-0 fw-bolder">Edit Employee Type</h4>
        <button
          className="btn-close"
        ...
        <div className="mt-4 mb-4 w-100">
          <div className="row g-3 align-items-center justify-content-between">
            <div className="col-12 col-md-6 form-group mt-1">
              ...
              />
              {invalidName && <div className="invalid-feedback">Type required?</div>}
            </div>
            <div className="col-12 col-md-6  form-group mt-1">
              <label
                className="pb-2"
              ...
              >
                Employee Type Description <span style={{ color: 'red' }}>*</span>
              </label>
              <input
                type="text"
