  ...
  return (
    ...
    <div className='col-lg-8 col-md-6 ms-0'>
      <div className='row ps-0'>
        ...
        <div className='col-md-9 mt-1 col-lg-6 mt-2  ps-0 d-flex' >
    ...
    <div className='col-lg-4 col-md-6  d-flex justify-content-end mt-2' >
      <div className='row'>
...
export default Subdepartmentheader