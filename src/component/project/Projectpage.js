...
// ... (previous imports)
import imghr from '../../assets/img/dashboard/imghr.png'
const Projectpage = () => {
                ...
                <table className="table no-border-radius">
                    <thead>
                        <tr>
                            ...
                            <th scope="col"><span className='tabledata' style={{paddingleft: '900px'}}>Department</span></th>
