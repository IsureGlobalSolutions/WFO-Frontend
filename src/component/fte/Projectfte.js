...
function Projectfte({ onBack, setActive }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await dispatch(addEditProjecttFTE(transformedData.fte))


      if (result?.payload?.isSuccess) {
        await  dispatch(getProjectFteData());
  ...
  return (
    ...
    <ProjectAPI/>
     ...
     <div className="p-3 ps-4 " style={{backgroundColor:"#FFFFFF" ,
            marginTop:"2px",
     }}>
        ...
        <svg
          ...
          <h4 className="m-0 Top-heading-tag">Add Project FTE</h4>
