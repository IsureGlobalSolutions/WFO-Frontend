...
import {  addEditSubDepartmentFTE,  getSubDepartmentFteById, getSubdepFteData, OrganizationFteById } from "../../redux/features/auth/authSlice";
...
function Subdepfte({ onBack, setActive }) {
  ...
  const SubDepartmentname = useSelector(
    (state) => state.auth.SubDepartmentList
  );
  ...
  const handleDepartmentChange = (event) => {
    ...
    const department = SubDepartmentname.find(dep => dep.id === Number(subDepartmentId));
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await dispatch(addEditSubDepartmentFTE(transformedData.fte));

      if (result?.payload?.isSuccess) {
        await dispatch(getSubdepFteData());
        onBack();
    ...
    <SubdepartmentAPI/>
      ...
      >
        ...
        <svg
          ...
          <h4 className="m-0 Top-heading-tag">Add Sub-Department FTE</h4>
        
        </div>

        <div className="row">
          <div className="mb-3 col-md-4">
            <label className="mb-1 label-tag">FTE Name</label>
            <input
              type="text"
          ...
          <div className="col-md-4">
            <label className="mb-1 label-tag" htmlFor="departmentSelect">
              Sub-Department
            </label>
            <select
              id="departmentSelect"
            ...
            >
              ...
              {SubDepartmentname?.map((department) => (
        ...
        <div className="pt-3 mb-4">
          ...
          <div className="row mb-3">
            <div className="col-md-4">
              <label className="mb-1 label-tag">Daily Working Hours</label>
              <input
            ...
            <div className="col-md-4">
              <label className="mb-1 label-tag">Weekly Working Days</label>
              <input
                className={`form-control ${
          ...
          {/* Break Hours */}
          <div className="mb-3">
            <label className="mb-1 label-tag">Daily Break Hours</label>
          ...
          <div className="mb-3">
            <div className="d-flex align-items-center mb-2">
              <h5 className=" Top-heading-tag me-2 mt-3">Gazetted Holidays</h5>
            </div>
            <div className="row g-2">
              <div className="col-md-4">
                <label className="mb-1 label-tag">Select Region</label>
                <select
              ...
              <div className="col-md-4">
                <label className="mb-1 label-tag">Select Country</label>
                <select
                  className="form-select"
              ...
              <div className="col-md-4">
                <label className="mb-1 label-tag">Days</label>
                <input
          ...
          <div className="row mb-3">
            <div className="col-md-4">
              <label className="mb-1 label-tag">Annual Leaves</label>
              <input
                className={`form-control ${
            ...
            <div className="col-md-4">
              <label className="mb-1 label-tag">Sick Leaves</label>
              <input
                className={`form-control ${
            ...
            <div className="col-md-4">
              <label className="mb-1 label-tag">Casual Leaves</label>
              <input
                className={`form-control ${
          ...
          {/* Other Away Days */}
          <div className="mb-4">
            <label className="pb-2 label-tag">Other Away Days</label>
            <div className="d-flex align-items-center mb-2">
