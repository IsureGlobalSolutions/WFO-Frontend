...
import {  addEditProjecttFTE, addEditSubDepartmentFTE,  addEditTeamtFTE,  getProjectFteById,  getProjectFteData,  getSubDepartmentFteById, getSubdepFteData, getTeamFteById, getTeamFteData, OrganizationFteById } from "../../redux/features/auth/authSlice";
...
function Teamfte({ onBack ,  setActive }) {
  ...
  const handleDepartmentChange = (event) => {
    ...
    const department = Teamname.find(dep => dep.id === Number(ProjectId));
    ...
    setFormValues(prev => ({
      ...
      fte: {
        ...prev.fte,
        teamId: ProjectId ? Number(ProjectId) : null,
      },
    }));
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await dispatch(addEditTeamtFTE(transformedData.fte));

      if (result?.payload?.isSuccess) {
        await  dispatch(getTeamFteData());
        onBack();
  ...
  return (
    ...
    <TeamAPI/>
     ...
     <div className="p-4 " style={{ backgroundColor:"#FFFFFF"  , marginTop:"2px"}}>
        ...
        <svg
          ...
          <h4 className="m-0 Top-heading-tag">Add Team FTE</h4>
        ...
        <div className="row">
          ...
          <div className="col-md-4">
            <label className="label-tag pb-1" htmlFor="departmentSelect">
             Team
            </label>
            <select
              id="departmentSelect"
              className={`form-select ${formErrors.teamId ? "is-invalid" : ""}`}
            ...
            {formErrors.teamId && (
              <div className="invalid-feedback">{formErrors.teamId}</div>
            )}
          </div>
        </div>
        ...
        <div className="pt-3 mb-4">
          ...
          <div className="row mb-3">
            <div className="col-md-4">
              <label className="label-tag pb-1">Daily Working Hours</label>
              <input
            ...
            <div className="col-md-4">
              <label className="label-tag pb-1">Weekly Working Days</label>
              <input
                className={`form-control ${
