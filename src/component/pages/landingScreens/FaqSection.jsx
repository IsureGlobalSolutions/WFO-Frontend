                ...
                >
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        Task management involves organizing and overseeing tasks
                        to achieve goals. It includes planning, tracking
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="faqheadingTwo">
                      ...
                      >
                        02. Is HRWHIZZ suitable for my business?
                      </button>
                    </h2>
                    <div
                      id="faqcollapseTwo"
                    ...
                    >
                      <div className="accordion-body">
                        Certainly, The HRWHIZZ&apos;s suitability for your
