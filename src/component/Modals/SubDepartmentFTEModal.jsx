...
function SubDepartmentFTEModal({ onBack, setActive, selectedId }) {
  ...
  console.log("🚀 ~ SubDepartmentFTEModal ~ SubDepartmentname:", SubDepartmentname)
  ...
  useEffect(() => {
    ...
    if (selectedId) {
      ...
      dispatch(getSubDepartmentFteById(selectedId)).then((res) => {
        if (res?.payload) {
          ...
          const department = SubDepartmentname?.find((item) => item.id === res.payload.subDepartmentId);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await dispatch(addEditSubDepartmentFTE(transformedData.fte))
        .then((res) => {
  ...
  >
 {
        ...
        <div className="pt-3 mb-4">
          ...
          <div className="mb-3">
            <div className="d-flex align-items-center mb-2">
              <h5 className="fte-label fw-bolder me-2">Gazetted Holidays</h5>
            </div>
...
export default SubDepartmentFTEModal;